...
public class Encryption {
    ...
    public static @Nullable String decrypt(String text, @Nullable Key aesKey) throws IllegalArgumentException {
        if (aesKey == null) {
            return text;
        }
        try {
            ...
            throw new IllegalArgumentException("Illegal Base64: "+text+" # "+e.getMessage());
        }
    }
